  ...
  const electronicsModules = [
    {
      ...
      moduleHighlights: [
        ...
        "Debugging problems ",
        "Imagine and Create ",
        "Sustain focus and perseverance ",
      ],
      moduleCompetenicies: [
        "Create their own games, stories, and animations",
        "Create logical code",
        "Search and find bugs",
        "Work on a project from start to end",
      ],
    ...
    },
    {
      ...
      moduleHighlights: [
        "Programming techniques for micro-controllers",
        "Basic electronics circuits",
        "Input-output peripherals ",
        "Arduino sensor technologies ",
        "Motors and other actuators ",
        "Do-It-Yourself projects with Arduino ",
      ],
      moduleCompetenicies: [
        "Identify elements on an Arduino micro-controller",
    ...
    },
    {
      ...
      moduleHighlights: [
        "Recreate circuits on the breadboard ",
        "Electricity flow ",
      ...
      moduleCompetenicies: [
        "Understand conductivity, and resistance ",
  ...
  const scienceModules = [
    {
      ...
      moduleHighlights: [
        "Study the chemistry of materials from non-biological origins.",
