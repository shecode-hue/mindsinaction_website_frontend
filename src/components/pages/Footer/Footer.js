        ...
        <div className='row'>
          ...
          <div className='col'>
            ...
            <div className='social-icons'>
              ...
              <a href='https://twitter.com/Minds_In_Action' target='_blank' rel="noreferrer">
              ...
              <a href='https://www.tiktok.com/@mindsinaction?_t=8co12SVnpHp&_r=1' target='_blank' rel="noreferrer">
                <SiTiktok className="fab" />
              </a>
              <a href='https://www.instagram.com/minds_in_action/' target='_blank' rel="noreferrer">
